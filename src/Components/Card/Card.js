...
export default function Card(props) {
  ...
  return (
    <div className={`card set character${props.id.split('-')[0]} count${props.difficulty} ${props.set.includes(props.id) || active || props.study ? 'active' : ''} ${props.wonSet.includes(props.id) ? 'won' : ''}`} onClick={handleClick}>
